...
/***/ function(module, exports, __webpack_require__) {
	...
	var ApiClient = __webpack_require__(6);
	var Renderer = __webpack_require__(7);
	var NavGenerator = __webpack_require__(8);
...
/***/ function(module, exports) {
	...
	riot.tag("owners", "<input placeholder=\"Search\" name=\"input\" onkeyup=\"{ filterItems }\"> <table> <tr><th>Path</th><th>Owners</th></tr> <tr each=\"{ path, owners in filteredItems }\"> <td><a href=\"{ path }\">{ path }</a></td> <td>{ owners.join(', ') }</td> </tr> </table>", function (opts) {
